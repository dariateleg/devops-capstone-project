...
class TestAccountService(TestCase):
    ...
    def test_read_account_not_exists(self):
        ...
        resp = self.client.get(
            f"{BASE_URL}/15", content_type="application/json"
        )
    ...
    def test_delete_account_no_failure(self):
        """It should not Delete an Account if not present, but shouldn't fail"""
        resp = self.client.delete(f"{BASE_URL}/15")
        self.assertEqual(resp.status_code, status.HTTP_204_NO_CONTENT)